...
import java.util.*;
import progetto_2019_2020.Conn_Server.ConnessioneIds;
import progetto_2019_2020.Preleva_Informazioni.*;
public class LeggiLabs extends LeggiStringa {
    ...
    File file=new File("src\\main\\java\\progetto_2019_2020\\Conn_Server\\twitter2.json");
    try{
